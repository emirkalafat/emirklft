...
<body>
<h1>Enfes Tarifler GİZLİLİK BİLDİRİMİ</h1>
<p>
...
<p>
<strong>Bu Gizlilik Bildirimindeki bölümler size aşağıdakiler hakkında bilgi verir:</strong><br>
...
<p>
<strong>A. Hizmetimiz tarafından kullanılan Kişisel Veriler </strong>
Hizmetimizi geliştirmek için Anonim Verileri kullanırız. Bu bilgiler, Hizmet aracılığıyla kamuya açıklanmayacaktır.
</p>
<p>
	<strong>B. Otomatik olarak oluşturulan bilgiler </strong>
	Çoğu diğer web siteleri ve çevrimiçi hizmetler gibi, Uygulamayı nasıl kullandığınızla ilgili olarak otomatik olarak üretilen bilgileri toplar ve işleriz. Toplanan bilgiler, ip adresinizi ve / veya benzersiz cihaz kimliğinizi içerir. <br><br>
...
Not: kullanıcı yetkilendirme özellikleri etkinleştirilmişse, giriş yaptığınızda anonim bilgileri sizin bilgilerinizle ilişkilendirebiliriz.<br>
</p>
<p>
	<strong>C. Belirli Bilgiler </strong><br>
	Size sadakat kartı, haber bültenleri, reklamcılık gibi bazı etkinliklerle başvurmanız istenebilir; bu durumda bazı kişisel bilgiler istenir. Bu bilgiler, hizmetimizin (üçüncü şahıslar dahil) veritabanında saklanır ve bizimle paylaşılacaktır. <br><br>
...
<p>
Hizmet kapsamında işlenen verilerin tutulduğu veri merkezileri değişik bölgelerde bulunmaktadır., Türkiye, İrlanda, Hollanda, Amerika Birleşik Devletleri bölgelerinde yer alan barındırma hizmetleri kullanılarak sağlanmaktadır. Bununla birlikte, işlenen Kişisel Veriler, bu ülkeler ve bölgeler dışında bir ülkede bulunan muhafaza sunucularına aktarılabilir ve depolanabilir. Kişisel Verilerinizin güvenli bir şekilde ve bu gizlilik politikasına uygun şekilde kullanılmasını sağlamak için makul ölçüde gerekli tüm adımları atacağız. <br> </p>
<h2>5. Kişisel Verileri korumak için hangi güvenlik önlemleri uygulanmaktadır?</h2>
<p>
...
<h2>11. Herhangi bir sorunuz ya da açıklamalarınız varsa ne yapacaksınız?</h2>
<p>Bu Gizlilik Bildirimi ile ilgili herhangi bir sorunuz veya açıklamalarınız varsa, lütfen iletişim adresine bir e-posta göndererek bizimle iletişime geçin. </p>
</body>
</html>
""";
}
