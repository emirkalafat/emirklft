...
class ReviewCardNew extends StatefulWidget {
  ...
  @override
  State<ReviewCardNew> createState() => _ReviewCardNewState();
}

class _ReviewCardNewState extends State<ReviewCardNew> {
                  ...
                  children: [
                    ...
                    Container(
                      ...
                      decoration: BoxDecoration(
                        border: Border(
                          left: BorderSide(
                            color: _isHovered ? colorScheme.primary : Colors.white.withOpacity(0.1),
                            width: 2,
                          ),
                        ),
                      ),
